...
void	ft_rotate(t_stack **stack1, t_stack **stack2, t_info *info, char x) // first node becomes last
{
	t_stack	*tmp;
	t_stack	*first;
...
void	ft_rev_rotate(t_stack **stack1, t_stack **stack2, t_info *info, char x) // last node becomes first
{
	t_stack	*tmp;
	t_stack	*last;
